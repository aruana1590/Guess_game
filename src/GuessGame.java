public class GuessGame {
    ...
    public void startGame(){
      ...
      int guessp3=0;
        ...
        //объявляем 3 переменные для хранения правильности или неправильности (true или false) ответов игроков.
      ...
      int targetNumber=(int)(Math.random()*10);
        ...
        while(true){
            ...
            //Извлекаем варианты каждого игрока (результаты работы их методов
            // guess()), получая доступ к их переменным number
            guessp1=p1.number;
            ...
            //Проверка вариантов каждого игрока на соответствие заданному числу
            ...
            if(p1isRight||p2isRight||p3isRight){
                ...
                System.out.println("гроки должны попробовать еще раз.");
            }
        }
    }
}
